...
```
@MacBook-Pro workspace_React-todo % cd React-todo 
@MacBook-Pro React-todo % npm create vite@latest

Need to install the following packages:
  create-vite@5.5.2
Ok to proceed? (y) y
✔ Project name: … react-todo-pj
✔ Select a framework: › React
✔ Select a variant: › JavaScript

Scaffolding project in /Users/takahashimai_1/Desktop/_workspace_tec/workspace_React-todo/React-todo/react-todo-pj...
...
@MacBook-Pro react-todo-pj % npm i 
...
added 264 packages, and audited 265 packages in 7s

102 packages are looking for funding
  run `npm fund` for details

found 0 vulnerabilities
@MacBook-Pro react-todo-pj %   npm run dev

> react-todo-pj@0.0.0 dev
> vite
